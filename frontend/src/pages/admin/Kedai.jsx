                ...
                <tr key={k.id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      {!k.is_verified && <button className="btn btn-sm btn-success" onClick={() => verify(k.id)}>✓ Verifikasi</button>}
                      <button className="btn btn-sm btn-danger" onClick={() => deleteKedai(k.id)}>🗑️</button>
                    </div>
                  </td>
                </tr>
              ))}
